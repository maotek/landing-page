...
const Navbar = () => {
  ...
  return (
    <header className='absolute inset-x-0 top-0 py-6 bg-body border-b z-50 border-gray-800 dark:border-white'>
        <Container>
          <nav className="w-full flex justify-between gap-6 relative">
            ...
            <div className='min-w-max inline-flex relative'>
              <a href='/' className='relative flex items-center gap-3'>
                ...
                <div className='inline-flex text-lg font-semibold text-heading-1 transition duration-300'>
                  EdgeAI
                </div>
              </a>
            </div>
            ...
            border-x border-x-box-border lg:border-x-0 lg:h-auto h-0 overflow-hidden'>
              ...
              <ul className='border-t border-box-border lg:border-t-0 pc-6 lg:px-0 pt-6
               lg:pt-0 flex flex-col lg:flex-row gap-y-4 gap-x-3 text-lg text-heading-2
              ...
              px-6 lg:px-0 shrink-0'>
                <BtnLink text="Get Started" href="#cta" className=""/>
              </div>
            </div>

            <div className='lg:min-w-max sm:w-max flex items-center gap-x-3'>
