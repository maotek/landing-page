  ...
  return (
    <section className='relative pt-32 lg:pt-36'>
      <Container className='flex flex-col lg:flex-row gap-10 lg:gap-12'>
        ...
        <div className='relative flex flex-col item-center text-center lg:text-left lg:py-8 lg:items-start 
        lg:max-w-none max-w-3xl mx-auto lg:mx-0 lg:flex-1 lg:w-1/2'>
          <h1 className='text-heading-1 text-3xl sm:text-4xl md:text-4xl xl:text-6xl font-bold'>
         ...
         <div className='flex flex-1 lg:w-1/2 lg:h-auto relative lg:max-w-none lg:mx-0 mx-auto max-w-3xl'>
            <img src='https://images.pexels.com/photos/7773731/pexels-photo-7773731.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'
                  ...
                  width={2350}
                  height={2359}
                  className='lg:absolute lg:w-full lg:h-full rounded-3xl object-cover lg:max-h-none max-h96'
            />
          </div>
